...
$GLOBALS['_CRM_ADMIN_FORM_OPTIONVALUE']['_gid'] =  null;
...
class CRM_Admin_Form_OptionValue extends CRM_Admin_Form
{
     ...
     function buildQuickForm( ) 
    {
        ...
        if ($this->_action == CRM_CORE_ACTION_UPDATE && CRM_Core_DAO::getFieldValue( 'CRM_Core_DAO_OptionValue', $this->_id, 'is_reserved' )) { 
