...
$GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPTYPE']['_links'] =  null;
...
class CRM_Member_Page_MembershipType extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPTYPE']['_links'])) {
            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this membership type?');

            $GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPTYPE']['_links'] = array(
        ...
        return $GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPTYPE']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $membershipType[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Member_Page_MembershipType::links(), $action, 
                                                                            array('id' => $dao->id));
        }
