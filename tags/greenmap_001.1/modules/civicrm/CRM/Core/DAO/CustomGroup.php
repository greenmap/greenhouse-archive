...
$GLOBALS['_CRM_CORE_DAO_CUSTOMGROUP']['_log'] =  false;
...
class CRM_Core_DAO_CustomGroup extends CRM_Core_DAO {
    ...
    *
    * @var enum('Contact', 'Individual', 'Household', 'Organization', 'Location', 'Address', 'Contribution', 'Activity', 'Relationship', 'Phonecall', 'Meeting', 'Group')
    */
    var $extends;
    /**
    ...
    */
    function getLog() 
    {
        return $GLOBALS['_CRM_CORE_DAO_CUSTOMGROUP']['_log'];
    }
    /**
