...
$GLOBALS['_CRM_CORE_SELECTVALUES']['unitList'] =  null;
$GLOBALS['_CRM_CORE_SELECTVALUES']['periodType'] =  null;
$GLOBALS['_CRM_CORE_SELECTVALUES']['visible'] =  null;
$GLOBALS['_CRM_CORE_SELECTVALUES']['eventDate'] =  null;
...
class CRM_Core_SelectValues {
     ...
     function &unitList($unitType = null)
    {
        ...
        if (!$GLOBALS['_CRM_CORE_SELECTVALUES']['unitList']) {
            $GLOBALS['_CRM_CORE_SELECTVALUES']['unitList'] = array(
                              ''             => ts('- select -'),
                              'day'          => ts('day'),
                              'month'        => ts('month'),
                              'year'         => ts('year')
            ...
            if ( $unitType == 'duration' ) {
                ...
                $GLOBALS['_CRM_CORE_SELECTVALUES']['unitList'] = array_merge( $GLOBALS['_CRM_CORE_SELECTVALUES']['unitList'], $unitAdd);
            }
        }
        return $GLOBALS['_CRM_CORE_SELECTVALUES']['unitList'];
    }
     ...
     function &periodType()
    {
        ...
        if (!$GLOBALS['_CRM_CORE_SELECTVALUES']['periodType']) {
            $GLOBALS['_CRM_CORE_SELECTVALUES']['periodType'] = array(
                 ''             => ts('- select -'),
                 'rolling'      => ts('rolling'),
                 'fixed'        => ts('fixed')
             );
        }
        return $GLOBALS['_CRM_CORE_SELECTVALUES']['periodType'];
    }
     ...
     function &memberVisibility()
    {
        ...
        if (!$GLOBALS['_CRM_CORE_SELECTVALUES']['visible']) {
            $GLOBALS['_CRM_CORE_SELECTVALUES']['visible'] = array(
                 'Public'       => ts('Public'),
                 'Admin'        => ts('Admin')
             );
        }
        return $GLOBALS['_CRM_CORE_SELECTVALUES']['visible'];
    }
     ...
     function &eventDate()
    {
        ...
        if (!$GLOBALS['_CRM_CORE_SELECTVALUES']['eventDate']) {
            $GLOBALS['_CRM_CORE_SELECTVALUES']['eventDate'] = array(
                 ''             => ts('- select -'),
        ...
        return $GLOBALS['_CRM_CORE_SELECTVALUES']['eventDate'];
    }
