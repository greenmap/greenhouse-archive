...
$GLOBALS['_CRM_MEMBER_BAO_MEMBERSHIPSTATUS']['_defaultMembershipStatus'] =  null;
...
class CRM_Member_BAO_MembershipStatus extends CRM_Member_DAO_MembershipStatus 
{
     ...
     * class constructor
     */
    function CRM_Member_BAO_MembershipStatus( ) 
    {
        parent::CRM_Member_DAO_MembershipStatus( );
    }
     ...
     * @static
     */
     function del($membershipStatusId) 
    {
        //check dependencies
     ...
     * @static
     */
     function getMembershipStatusByDate( $startDate, $endDate, $joinDate, $statusDate = 'today' ) 
    {
