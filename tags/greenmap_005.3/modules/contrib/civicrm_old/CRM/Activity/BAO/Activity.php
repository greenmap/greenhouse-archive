...
class CRM_Activity_BAO_Activity extends CRM_Activity_DAO_Activity
{
     ...
     * class constructor
     */
    function CRM_Activity_BAO_Activity( ) 
    {
        parent::CRM_Activity_DAO_Activity( );
    }
     ...
     * @static
     */
     function add( &$params, &$ids, $activityType ) 
    {
        if ( ! CRM_Activity_BAO_Activity::dataExists( $params ) ) {
            return null;
        }
     ...
     * @static
     */
     function retrieve( &$params, &$defaults, $activityType ) 
    {
        eval ( '$activity =& new CRM_Activity_DAO_' . $activityType . '( );' );
        $activity->copyValues( $params );
     ...
     * @return
     */
      function createActivity( &$params, &$ids, $activityType = 'Meeting') 
    {
     ...
     * @access public
     */
     function showActivityDetails( $id, $activityHistoryId )
    {
        $params   = array( );
        $defaults = array( );
