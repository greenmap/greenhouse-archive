                ...
                case 'String':
                    ...
                    if ( is_array( $value ) ) {
                        ...
                        if ($field['html_type'] == 'CheckBox') {
                            foreach ( $value as $k => $v ) { 
                                $sqlValue[] = CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR . $k . CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR;
                            }
                            ...
                            foreach ( $value as $k => $v ) { 
                                $sqlValue[] = CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR . $v . CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR;
                            }
                            $this->_where[$grouping][] = $sql . "like '%" . implode( '%',  $sqlValue ) . "%'";
                            $this->_qill[$grouping][]  = ts('%1 %3 %2', array(1 => $field['label'], 2 => $qillValue, 3 => $op));
                        }                    
