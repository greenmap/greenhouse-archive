     ...
     */
      function &group( ) {
        if ( ! isset( $GLOBALS['_CRM_CORE_PERMISSION_DRUPAL']['_viewPermissionedGroups'] ) ) {
            ...
            if ( CRM_Core_Permission_Drupal::check( 'edit all contacts' ) ) {
            ...
            } else if ( CRM_Core_Permission_Drupal::check( 'view all contacts' ) ) {
            ...
            foreach ( $groups as $id => $title ) {
                if ( CRM_Core_Permission_Drupal::check( CRM_CORE_PERMISSION_EDIT_GROUPS . $title ) ) {
                ...
                } else if ( CRM_Core_Permission_Drupal::check( CRM_CORE_PERMISSION_VIEW_GROUPS . $title ) ) {
                    $GLOBALS['_CRM_CORE_PERMISSION_DRUPAL']['_viewPermissionedGroups'][$id] = $title;
                    $GLOBALS['_CRM_CORE_PERMISSION_DRUPAL']['_viewPermission']      = true;
                } 
            }
