...
class CRM_Contact_Page_View_DashBoard extends CRM_Contact_Page_View {
    ...
    var $_rows = array();
    var $_totalCountOpenActivity = array();
    var $_totalCountActivity = array();
    var $_contactIds = array();
    var $_history = array();
    var $_displayName = array();
    ...
    function preProcess()
    {
        ...
        if( CRM_Contact_BAO_Contact::permissionedContact( $uid, CRM_CORE_PERMISSION_VIEW ) ) {
