...
class CRM_Member_StateMachine_Search extends CRM_Core_StateMachine {
     ...
     * class constructor
     */
    function CRM_Member_StateMachine_Search( $controller, $action = CRM_CORE_ACTION_NONE ) {
     ...
     */
       function taskName( $controller, $formName = 'Search' ) {
        ...
        if ( CRM_Utils_Array::value( '_qf_' . $formName . '_next_print', $_POST ) ) {
            $value = CRM_MEMBER_TASK_PRINT_MEMBERS;
        } else {
        ...
        $result = false;
        switch ( $value ) {
        case CRM_MEMBER_TASK_DELETE_MEMBERS:
            $task   = 'CRM_Member_Form_Task_Delete';
            break;

        case CRM_MEMBER_TASK_EXPORT_MEMBERS:
