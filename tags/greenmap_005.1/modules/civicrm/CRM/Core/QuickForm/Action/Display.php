...
class CRM_Core_QuickForm_Action_Display extends CRM_Core_QuickForm_Action {
    ...
    function initializeTemplates() {
        ...
        $GLOBALS['_CRM_CORE_QUICKFORM_ACTION_DISPLAY']['_requiredTemplate'] = file_get_contents( $config->templateDir . '/CRM/Form/label.tpl' );
        $GLOBALS['_CRM_CORE_QUICKFORM_ACTION_DISPLAY']['_errorTemplate']    = file_get_contents( $config->templateDir . '/CRM/Form/error.tpl' );
    }
