        ...
        while($customValueDAO->fetch()) {
            if ($customValueDAO->int_data == $oldValue) {
                ...
                if ( $customValueDAO->char_data == $oldValue) {
                    ...
                    $updateValue = str_replace(CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR . $oldValue . CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR, CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR . $params['value'] . CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR, $customValueDAO->char_data );
                }
