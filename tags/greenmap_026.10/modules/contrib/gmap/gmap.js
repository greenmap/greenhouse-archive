...
function gmap_init() {
  ...
  baseIcon['flat'].iconSize = new GSize(20, 34);
  baseIcon['flat'].shadowSize = new GSize(0, 0);
  baseIcon['flat'].iconAnchor = new GPoint(9, 34);
  baseIcon['flat'].infoWindowAnchor = new GPoint(9, 2);

  baseIcon['greenhouse'] = new GIcon();
  baseIcon['greenhouse'].image = gmapMarkerLocation + "/greenhouse/icon_greenmap_google.png";
  baseIcon['greenhouse'].shadow = "";
  baseIcon['greenhouse'].iconSize = new GSize(18, 38);
  baseIcon['greenhouse'].shadowSize = new GSize(0, 0);
  baseIcon['greenhouse'].iconAnchor = new GPoint(5, 38);
  baseIcon['greenhouse'].infoWindowAnchor = new GPoint(14, 2);
 
  baseIcon['mapmakers'] = new GIcon();
  baseIcon['mapmakers'].image = gmapMarkerLocation + "/greenhouse/icon_mapmakers.png";
  baseIcon['mapmakers'].shadow = gmapMarkerLocation + "/invisible/invisible.png";
  baseIcon['mapmakers'].iconSize = new GSize(24, 40);
  baseIcon['mapmakers'].shadowSize = new GSize(0, 0);
  baseIcon['mapmakers'].iconAnchor = new GPoint(0, 40);
  baseIcon['mapmakers'].infoWindowAnchor = new GPoint(12, 2);
  
  baseIcon['invisible'] = new GIcon();
  baseIcon['invisible'].image = gmapMarkerLocation + "/invisible/invisible.png";
  baseIcon['invisible'].shadow = gmapMarkerLocation + "/invisible/invisible.png";
  baseIcon['invisible'].iconSize = new GSize(1, 1);
  baseIcon['invisible'].shadowSize = new GSize(0, 0);
  baseIcon['invisible'].iconAnchor = new GPoint(0, 0);
  baseIcon['invisible'].infoWindowAnchor = new GPoint(0, 0);
