...
class CRM_Core_Page_File extends CRM_Core_Page {
    ...
    function run( ) {
        ...
        $eid         = CRM_Utils_Request::retrieve( 'eid'   , 'Positive', $GLOBALS['_CRM_CORE_DAO']['_nullObject'], true );
        $id          = CRM_Utils_Request::retrieve( 'id'    , 'Positive', $GLOBALS['_CRM_CORE_DAO']['_nullObject'], true );
        $quest       = CRM_Utils_Request::retrieve( 'quest' , 'Positive', $GLOBALS['_CRM_CORE_DAO']['_nullObject'] );
