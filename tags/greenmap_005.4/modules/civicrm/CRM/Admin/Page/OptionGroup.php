...
$GLOBALS['_CRM_ADMIN_PAGE_OPTIONGROUP']['_links'] =  null;
...
class CRM_Admin_Page_OptionGroup extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_ADMIN_PAGE_OPTIONGROUP']['_links'])) {
            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this Option?');

            $GLOBALS['_CRM_ADMIN_PAGE_OPTIONGROUP']['_links'] = array(
        ...
        return $GLOBALS['_CRM_ADMIN_PAGE_OPTIONGROUP']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $optionGroup[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Admin_Page_OptionGroup::links(), $action, 
                                                                                    array('id' => $dao->id));
        }
