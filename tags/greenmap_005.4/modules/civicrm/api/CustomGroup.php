...
function crm_create_custom_value($entity_table, $entity_id, &$custom_field, &$data ,$separator = null)
{
    ...
    if ( $separator ) {
        ...
        require_once 'CRM/Core/BAO/CustomOption.php';
        $data['value'] = CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR.implode(CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR, $values).CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR;
    }
