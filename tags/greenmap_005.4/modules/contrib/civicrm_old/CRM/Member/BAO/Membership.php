...
$GLOBALS['_CRM_MEMBER_BAO_MEMBERSHIP']['_importableFields'] =  null;
...
class CRM_Member_BAO_Membership extends CRM_Member_DAO_Membership
{
    ...
    function CRM_Member_BAO_Membership()
    {
        parent::CRM_Member_DAO_Membership();
    }
...
";
     ...
     * @access public
     */
     function activeMembers( $contactId, $memberships, $status = 'active' ) {
        $actives = array();
        if ( $status == 'active' ) {
     ...
     * @static
     */
     function getMemershipBlock( $pageID ) {
        $membershipBlock = array();
        require_once 'CRM/Member/DAO/MembershipBlock.php';
        $dao = & new CRM_Member_DAO_MembershipBlock();
        $dao->entity_table = 'civicrm_contribution_page';
     ...
     * @static
     */
     function getContactMembership( $contactID , $memType ) {
