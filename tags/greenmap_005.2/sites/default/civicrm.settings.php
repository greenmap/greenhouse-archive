...
define( 'CIVICRM_UF_DSN', 'mysql://greenmap_12:p9A5zCGm@db82a.pair.com/greenmap_greenhouse?new_link=true' );
...
global $civicrm_root;
$civicrm_root = '/usr/www/users/greenmap/greenhouse/modules/civicrm/';
define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/usr/www/users/greenmap/greenhouse/files/civicrm/templates_c/' );
define( 'CIVICRM_UPLOADDIR'          , '/usr/www/users/greenmap/greenhouse/files/civicrm/upload/'  );
define( 'CIVICRM_IMAGE_UPLOADDIR'    , '/usr/www/users/greenmap/greenhouse/files/civicrm/images/');
define( 'CIVICRM_CUSTOM_FILE_UPLOADDIR'    , '/usr/home/greenmap/crm_docs/' );
...
define( 'CIVICRM_UF_BASEURL'      , 'http://www.greenmap.org/greenhouse/' );
define( 'CIVICRM_UF_RESOURCEURL'  , 'http://www.greenmap.org/greenhouse/modules/civicrm/' );
define( 'CIVICRM_IMAGE_UPLOADURL' , 'http://www.greenmap.org/greenhouse/files/civicrm/images/' );
...
define( 'CIVICRM_DSN'          , 'mysql://greenmap_12:p9A5zCGm@db82a.pair.com/greenmap_greenhouse?new_link=true' );
define( 'CIVICRM_MYSQL_PATH', '/usr/bin/' );
 ...
 */
define( 'CIVICRM_DEFAULT_CONTACT_COUNTRY_ID' , 'US' );
...
// old key
// define('CIVICRM_MAP_API_KEY', 'ABQIAAAAkBu6oIeS5dgYbFvl_i4xVRTEhE1nQKHXBcOgaxW84touC6OAChSPZkiiwYXUP1ELKw4sLmmxhn3qzQ');
define('CIVICRM_MAP_API_KEY', 'ABQIAAAA5cCT4BiBVzr4S4JHViU7KBQ4xjZcwkP2Xfck7BbmGt1l68IPaRTHgP2T4dsfSckOj9A1pakr9P7nww');
