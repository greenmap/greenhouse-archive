...
$GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['tasks'] = null;
...
class CRM_Core_PseudoConstant {
      ...
      function &country($id = false)
    {
        if (!$GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['country']) {
            ...
            if ( $config->defaultContactCountry ) {
                ...
                if ( $defaultID !== false ) {
                    $default[$defaultID] = $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['country'][$defaultID];
                    $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['country'] = $default + $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['country'];
                }
            }
    ...
    */
     ...
     */
      function &tasks( )
    {
        if ( ! $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['tasks'] ) {
            CRM_Core_PseudoConstant::populate( $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['tasks'], 'CRM_Project_DAO_Task', false, 'title', 'is_active', null, 'title' );
        }
        return $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['tasks'];
    }
