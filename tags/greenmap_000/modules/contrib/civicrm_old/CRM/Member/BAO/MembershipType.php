...
$GLOBALS['_CRM_MEMBER_BAO_MEMBERSHIPTYPE']['_defaultMembershipType'] =  null;
...
class CRM_Member_BAO_MembershipType extends CRM_Member_DAO_MembershipType 
{
     ...
     * class constructor
     */
    function CRM_Member_BAO_MembershipType( ) 
    {
        parent::CRM_Member_DAO_MembershipType( );
    }
    ...
    function getRenewalDatesForMembershipType( $membershipId ) 
    {
        ...
        $membershipTypeDetails = CRM_Member_BAO_MembershipType::getMembershipTypeDetails( $membershipDetails->membership_type_id );
