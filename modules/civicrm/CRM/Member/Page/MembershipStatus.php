...
$GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPSTATUS']['_links'] =  null;
...
class CRM_Member_Page_MembershipStatus extends CRM_Core_Page_Basic 
{
    ...
    function &links()
    {
        if (!($GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPSTATUS']['_links'])) {
            // helper variable for nicer formatting
            $disableExtra = ts('Are you sure you want to disable this membership type?');

            $GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPSTATUS']['_links'] = array(
        ...
        return $GLOBALS['_CRM_MEMBER_PAGE_MEMBERSHIPSTATUS']['_links'];
    }
    ...
    function browse()
    {
        ...
        while ($dao->fetch()) {
            ...
            $membershipStatus[$dao->id]['action'] = CRM_Core_Action::formLink(CRM_Member_Page_MembershipStatus::links(), $action, 
                                                                              array('id' => $dao->id));
