...
class CRM_Profile_Selector_Listings extends CRM_Core_Selector_Base {
     ...
     * @access public
     */
    function CRM_Profile_Selector_Listings( &$params, &$customFields, $ufGroupId = null, $map = false )
    {
        $this->_params = $params;
     ...
     function &links( $map = false )
    {
        if ( ! $GLOBALS['_CRM_PROFILE_SELECTOR_LISTINGS']['_links'] ) {
            ...
            if ( $map ) {
                $GLOBALS['_CRM_PROFILE_SELECTOR_LISTINGS']['_links'][CRM_CORE_ACTION_MAP] = array(
                                                            'name'  => ts('Map'),
    ...
    function &getRows($action, $offset, $rowCount, $sort, $output = null) {
        ...
        $links =& CRM_Profile_Selector_Listings::links( $this->_map );
