...
class CRM_Profile_Form extends CRM_Core_Form
{
            ...
            if ( CRM_Core_Permission::access( 'Quest' ) ) {
                ...
                if ($tableStudent) {
                    ...
                    foreach( $fields as $field ) {
                        if ( $defaults[$field] ) {
                            $values = explode(CRM_CORE_BAO_CUSTOMOPTION_VALUE_SEPERATOR , $defaults[$field] );
                    }
    ...
    {   
        ...
        if ( $this->_mode != CRM_PROFILE_FORM_MODE_REGISTER&& $this->_mode != CRM_PROFILE_FORM_MODE_SEARCH) {
            //check for mix profile fields (eg:  individual + other contact type)
        ...
        $search = ( $this->_mode == CRM_PROFILE_FORM_MODE_SEARCH) ? true : false;
