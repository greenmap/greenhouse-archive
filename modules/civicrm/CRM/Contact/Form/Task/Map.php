...
class CRM_Contact_Form_Task_Map  extends CRM_Contact_Form_Task {
    ...
    function preProcess( ) {
        ...
        CRM_Contact_Form_Task_Map::createMapXML( $this->_contactIds, $lid, $this, true );
     ...
     * @access protected
     */
     function createMapXML( $contactIds, $locationId, &$page, $addBreadCrumb ) {
        ...
        if ( $config->mapGeoCoding ) {
            ...
            while($locations[$i]['address']) {
                CRM_Contact_Form_Task_Map::geoCodeAddressFormat($locations[$i]);
                $i++;
            }
        }
     ...
     * @return None
     */
     function geoCodeAddressFormat( &$location ) {
