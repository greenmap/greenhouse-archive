...
$GLOBALS['_CRM_CORE_DAO_MAPPING']['_log'] =  false;
...
class CRM_Core_DAO_Mapping extends CRM_Core_DAO {
    ...
    * Type of Mapping.
    *
    * @var enum('Export', 'Import', 'Export Contributions', 'Import Contributions', 'Import Activity History', 'Search Builder')
    */
    var $mapping_type;
    /**
    * class constructor
    ...
    */
    function getLog() 
    {
        return $GLOBALS['_CRM_CORE_DAO_MAPPING']['_log'];
    }
    /**
