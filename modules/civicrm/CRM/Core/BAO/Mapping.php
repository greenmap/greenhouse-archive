...
class CRM_Core_BAO_Mapping extends CRM_Core_DAO_Mapping 
{
     ...
     * class constructor
     */
    function CRM_Core_BAO_Mapping( ) 
    {
        parent::CRM_Core_DAO_Mapping( );
    }
    ...
    {
        if ( ! CRM_Core_BAO_Mapping::dataExists( $params ) ) {
	  //return null;
        }
     ...
     * @static
     */
     function getMappings($mappingType)
    {
        $mappingArray = array();
     ...
     * 
     */
     function checkMapping($nameField,$mapType)
    {
     ...
     * @static
     */
     function buildMappingForm($form, $mappingType = 'Export', $mappingId = null, $columnNo, $blockCount = 3 ) 
    {
