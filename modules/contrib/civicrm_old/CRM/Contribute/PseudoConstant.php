...
$GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionPage'] = null;
...
class CRM_Contribute_PseudoConstant extends CRM_Core_PseudoConstant {
      ...
      function &contributionType($id = null)
    {
        ...
        if ($id) {
            return CRM_Utils_Array::value( $id, $GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionType'] );
        }
     ...
     * @static
     */
      function &contributionPage($id = null)
    {
        if ( ! $GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionPage'] ) {
            CRM_Core_PseudoConstant::populate( $GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionPage'],
                                               'CRM_Contribute_DAO_ContributionPage',
                                               false, 'title' );
        }
        if ( $id ) {
            return CRM_Utils_Array::value( $id, $GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionPage'] );
        }
        return $GLOBALS['_CRM_CONTRIBUTE_PSEUDOCONSTANT']['contributionPage'];
    }
