...
$GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'] =  null;
...
class CRM_Contribute_BAO_Contribution extends CRM_Contribute_DAO_Contribution
{
    ...
    function &exportableFields( ) {
        if ( ! $GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'] ) {
            if ( ! $GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'] ) {
                $GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'] = array();
            }
            ...
            $GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'] = $fields;
        }
        return $GLOBALS['_CRM_CONTRIBUTE_BAO_CONTRIBUTION']['_exportableFields'];
    }
