...
class CRM_Core_Invoke {
     ...
     */    
     function invoke( $args ) {
        ...
        case 'dashboard':
            CRM_Core_Invoke::dashboard($args);
            break;
     ...
     */
     function contact( $args ) {
        ...
        if ( $args[2] == 'add' ) {
            $contactType    = CRM_Utils_Request::retrieve('ct','String', $GLOBALS['_CRM_CORE_DAO']['_nullObject'],false,null,'GET');
            $contactSubType = CRM_Utils_Request::retrieve('cst','String', $GLOBALS['_CRM_CORE_DAO']['_nullObject'],false,null,'GET');
            return CRM_Core_Invoke::form( CRM_CORE_ACTION_ADD, $contactType, $contactSubType );
        }
        ...
        if ($args[2] == 'view') {
            ...
            case 'activity':
                $activityId = CRM_Utils_Request::retrieve('activity_id', 'Positive',
                                                          $GLOBALS['_CRM_CORE_DAO']['_nullObject'] );
            ...
            default:
                $id = CRM_Utils_Request::retrieve( 'cid', 'Positive', $GLOBALS['_CRM_CORE_DAO']['_nullObject'] ); 
                if ( ! $id ) {
     ...
     */
     function search( $args ) {
        ...
        $id = CRM_Utils_Request::retrieve('id', 'Positive',
                                          $GLOBALS['_CRM_CORE_DAO']['_nullObject'], false, 0, 'GET');
        if ( $id ) {
            $session->set('id', $id);
        }
     ...
     function profile( $args ) { 
        ...
        if ( $secondArg == 'edit' || $secondArg == 'create' ) {
            ...
            if ( $secondArg == 'edit' && $userID ) {
                $controller =& new CRM_Core_Controller_Simple( 'CRM_Profile_Form_Edit', ts('Create Profile'), CRM_CORE_ACTION_UPDATE );
                ...
                if ( $buttonType == 'Cancel' ) {
                    $cancelURL = CRM_Utils_Request::retrieve('cancelURL','String', $GLOBALS['_CRM_CORE_DAO']['_nullObject'],false,null,$_POST );
                    if ( $cancelURL ) {
