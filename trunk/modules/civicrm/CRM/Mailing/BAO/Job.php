...
$GLOBALS['_CRM_MAILING_BAO_JOB']['config'] =  null;
$GLOBALS['_CRM_MAILING_BAO_JOB']['mailsProcessed'] =  0;
...
class CRM_Mailing_BAO_Job extends CRM_Mailing_DAO_Job {
     ...
     */
      function runJobs() {
        ...
        $GLOBALS['_CRM_MAILING_BAO_JOB']['config'] =& CRM_Core_Config::singleton();
        $mailer =& $GLOBALS['_CRM_MAILING_BAO_JOB']['config']->getMailer();
     ...
     */
     function deliver(&$mailer) {
        ...
        if ( $GLOBALS['_CRM_MAILING_BAO_JOB']['config'] == null ) {
            $GLOBALS['_CRM_MAILING_BAO_JOB']['config'] =& CRM_Core_Config::singleton();
        }
        ...
        while ($eq->fetch()) {
            ...
            if ($GLOBALS['_CRM_MAILING_BAO_JOB']['config']->mailerBatchLimit > 0 and $GLOBALS['_CRM_MAILING_BAO_JOB']['mailsProcessed'] >= $GLOBALS['_CRM_MAILING_BAO_JOB']['config']->mailerBatchLimit) {
                exit;
            }
            $GLOBALS['_CRM_MAILING_BAO_JOB']['mailsProcessed']++;
